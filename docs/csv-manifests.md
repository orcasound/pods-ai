...
* URI: A URI where a human can listen to the audio.  The URI must contain a variation of the non-"rpi_" portion of the NodeName, either with underscores ("andrews_bay") or hyphens ("andrews-bay") somewhere in the URI path.
